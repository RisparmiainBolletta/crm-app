...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function mostraTabella(dati) {
        ...
        dati.forEach(p => {
            ...
            tr.innerHTML = `
                ...
                <td class="esigibilita-${(p.Esigibilità || "").toLowerCase()}">${p.Esigibilità || ""}</td>
            `;
    ...
    document.querySelectorAll("#thead-provvigioni th").forEach((th) => {
    ...
    function applicaFiltriCombinati() {
        const testo = document.getElementById("filtro-provvigioni").value.toLowerCase();
    ...
    document.getElementById("filtro-provvigioni").addEventListener("input", applicaFiltriCombinati);
