...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("filtro-competenza").addEventListener("input", function () {
        const valoreCompetenza = this.value.trim().toLowerCase();

        const filtrati = provvigioni.filter(p => {
            const comp = formatCompetenza(p.Competenza).toLowerCase();
            return comp.includes(valoreCompetenza);
        });
